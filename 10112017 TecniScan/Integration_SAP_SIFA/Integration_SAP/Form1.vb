...
Public Class Form1
    ...
    Public Function DepositosToma() As Boolean
        ...
        Try
            ...
            Dim objFSO As Object = CreateObject("Scripting.FileSystemObject")
            Dim objSubFolder As Object = "C:\TS\Depositos\"
            Dim objFolder As Object = objFSO.GetFolder(objSubFolder)
            Dim counter = My.Computer.FileSystem.GetFiles("C:\TS\Depositos\")
            Dim colFiles As Object = objFolder.Files
            Dim cant As Integer = counter.Count
            If cant > 0 Then
                For Each objFile In colFiles
                    ...
                    If existeDepositos() = 0 Then
                        Dim entra As String = "C:\TS\Depositos\" + objFile.Name.ToString
                        Dim integ As String = "C:\TS\Depositos\Integration\Deposito.xml"
                        File.Move(entra, integ)
                        DepositoIntegration()
                        'File.Delete("C:\TS\FacturaUpdate\Integration\Invoice.xml")
                        'File.Move(integ, temp)
    ...
    Private Function existeDepositos()
        If My.Computer.FileSystem.FileExists("C:\TS\Depositos\Integration\Deposito.xml") Then
            'ListBox1.Items.Add("Si Existe")
            Return 1
        Else
            'ListBox1.Items.Add("No Existe")
...
#Region "Mixta_N"
                    If (tipodepago = "" And pagoacuenta = "N") Then
                        ...
                        If oReturn <> 0 Then
                            ...
                            Dim entra2 As String = "C:\TS\Pagos\Integration\Payment.xml"
                            Dim sale2 As String = "C:\TS\Pagos\temp\ErrPayment" + DateTime.Now.ToString("yyyyMMddHHmmss") + "" + newstring5 + ".xml"
...
#End Region
    ...
    Private Sub DepositoIntegration()
        ...
        Dim oRecordSet As SAPbobsCOM.Recordset
        Try
            Dim entra As String = "C:\TS\Depositos\Integration\Deposito.xml"
            Dim sale As String = "C:\TS\Depositos\temp\Deposito" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xml"
            Dim Xml As XmlDocument = New XmlDocument()
            Xml.Load(entra)
...
#Region "CHQ"
                    If (tipodepago = "CHQ") Then
                        ...
                        Catch ex As Exception
                            ...
                            Dim newstring4 As String = Replace(newstring3, " ", "")
                            Dim newstring5 As String = Replace(newstring4, ":", "")
                            Dim entra2 As String = "C:\TS\Depositos\Integration\Deposito.xml"
                            Dim sale2 As String = "C:\TS\Depositos\temp\ErrDeposito" + DateTime.Now.ToString("yyyyMMddHHmmss") + "" + newstring5 + ".xml"
                            File.Move(entra2, sale2)
                        End Try
                    End If
...
#End Region
        ...
        Catch ex As Exception
            Dim entra As String = "C:\TS\Depositos\Integration\Deposito.xml"
            Dim sale As String = "C:\TS\Depositos\temp\ErrDeposito" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xml"
            File.Move(entra, sale)
        End Try
    End Sub
End Class
