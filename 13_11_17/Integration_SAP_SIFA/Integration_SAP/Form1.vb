...
Public Class Form1
    ...
    Public Function MakeConnectionSAP() As Boolean
        ...
        Try
            ...
            If Connected <> 0 Then
                ...
                My.Computer.FileSystem.WriteAllText("C:\IntegracionSAP\Integracion\LogConexion.txt", DateTime.Now.ToString("dd/MM/yyyy-HH:mm:ss") & oCompany.GetLastErrorDescription, True)

                '   Process.GetProcessesByName("Integration_SAP")(0).Kill()
            Else
    ...
    Private Function PagoIntegration(archivo As String)
        ...
        Try
            ...
            For Each xnDoc As XmlNode In ArticleList
                ...
                If (pagoacuenta = "N") Then
                    If MakeConnectionSAP() Then
                        ...
                        File.Move(entra, integ)
                    Else
                        My.Computer.FileSystem.WriteAllText("C:\IntegracionSAP\Pagos\temp\LogErrorPagos.txt", DateTime.Now.ToString("dd/MM/yyyy-HH:mm:ss") & " - " & entra.Substring(24) & oCompany.GetLastErrorDescription, True)
                        'Dim integ As String = "C:\IntegracionSAP\Pagos\Integration\Payment.xml"
                        Dim temp As String = "C:\IntegracionSAP\Pagos\temp\" + entra.Substring(24) + ".xml"
                        'File.Copy(entra, temp)
                        File.Move(entra, temp)
                    End If
            ...
            'Return termina = 1
        Catch ex As Exception
            My.Computer.FileSystem.WriteAllText("C:\IntegracionSAP\Pagos\temp\LogErrorPagos.txt", DateTime.Now.ToString("dd/MM/yyyy-HH:mm:ss") & "Error en pago verifique log integracion" & oCompany.GetLastErrorDescription, True)
        End Try
    End Function
